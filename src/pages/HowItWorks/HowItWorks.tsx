              ...
              <div className="accordion-item">
                ...
                <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                  <div className="accordion-body">
                    <strong>Browse</strong> through a variety of clubs. Fiction, non-fiction, fantasy, memoirs, and more. Each club has its own community and vibe, so you'll always find a perfect match.
                  </div>
                </div>
              </div>
              <div className="accordion-item">
